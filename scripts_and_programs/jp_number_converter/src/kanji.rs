...
fn digits_2(input_string: &str) -> String {
    ...
    if first_char != "0" {
        return format!("{}{}{}", dict.get(first_char).unwrap().to_string(), "十", digits_1(second_char, false));
    }
...
fn digits_3(input_string: &str) -> String {
    ...
    return format!("{}{}{}", dict.get(first_char).unwrap().to_string(), "百", digits_2(remaining_chars))
}
...
fn digits_4(input_string: &str, prefix: bool) -> String {
    ...
    if first_char == "1" && prefix {
        return format!("{}{}{}", dict.get(first_char).unwrap().to_string(), "一千", digits_3(remaining_chars))
    }
    return format!("{}{}{}", dict.get(first_char).unwrap().to_string(), "千", digits_3(remaining_chars))
}
...
fn digits_9(input_string: &str) -> String {
    ...
    if remaining_chars_0 != "0000" {
        return format!("{}{}{}{}{}", dict.get(first_char).unwrap().to_string(), "億", digits_4(remaining_chars_0, true), "万", digits_4(remaining_chars_1, true));
    }
...
fn digits_10(input_string: &str) -> String {
    ...
    if remaining_chars_0 != "0000" {
        return format!("{}{}{}{}{}", digits_2(first_chars), "億", digits_4(remaining_chars_0, true), "万", digits_4(remaining_chars_1, true));
    }
...
fn digits_11(input_string: &str) -> String {
    ...
    if remaining_chars_0 != "0000" {
        return format!("{}{}{}{}{}", digits_3(first_chars), "億", digits_4(remaining_chars_0, true), "万", digits_4(remaining_chars_1, true));
    }
...
fn digits_12(input_string: &str) -> String {
    ...
    if remaining_chars_0 != "0000" {
        return format!("{}{}{}{}{}", digits_4(first_chars, true), "億", digits_4(remaining_chars_0, true), "万", digits_4(remaining_chars_1, true));
    }
